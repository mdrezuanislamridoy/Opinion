<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body class="bg-gray-200 h-screen flex justify-center items-center ">
        <div class="w-96 relative border-4 border-black bg-white shadow-md rounded-lg flex items-center justify-center" style="height: 600px;">
            <div  class="flex justify-center items-center flex-col text-lg bg-slate-500 text-white w-80 shadow-lg rounded-lg p-8 ">
